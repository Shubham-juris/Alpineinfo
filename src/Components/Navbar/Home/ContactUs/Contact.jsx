...
const Contact = () => {
  ...
  const contactInfoText = "AlpineInfo is a technology company specializing in software solutions, IT consulting, cloud services, and digital transformation for businesses worldwide.";
        ...
        {[
          {
            ...
            content: (
              ...
              >
                10030 106 St Westlock
                Alberta, Canada T7P 2K4
              </a>
            ),
          },
          {
            ...
            title: "Phone Number",
            content: (
              <a href="tel:+1 780-287-8141" style={{ textDecoration: "none", color: "inherit" }}>
                +1 780-287-8141
              </a>
            ),
          },
          {
            ...
            content: (
              <a href="
alpineinfotech4@gmail.com" style={{ textDecoration: "none", color: "inherit" }}>          
alpineinfotech4@gmail.com
              </a>
            ),
          },
        ].map((card, index) => (
